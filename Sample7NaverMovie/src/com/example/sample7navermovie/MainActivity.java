				...
				.setOnLastItemVisibleListener(new OnLastItemVisibleListener() {
					...
					public void onLastItemVisible() {
						...
						if (keyword != null && !keyword.equals("")) {
							...
							if (nextstart != -1) {
								NetworkManager.getInstnace().getNaverMovie(
										MainActivity.this, keyword, nextstart,
										10,
										new OnResultListener<NaverMovies>() {

											@Override
											public void onSuccess(
													final NaverMovies result) {
								...
								Toast.makeText(MainActivity.this,
										"no more data", Toast.LENGTH_SHORT)
										.show();
							}
						} else {
							Toast.makeText(MainActivity.this, "not set data",
		...
		refreshView.setOnRefreshListener(new OnRefreshListener<ListView>() {
			...
			public void onRefresh(PullToRefreshBase<ListView> view) {
				...
				if (keyword != null && !keyword.equals("")) {
					...
					if (nextstart != -1) {
						NetworkManager.getInstnace().getNaverMovie(
								MainActivity.this, keyword, nextstart, 10,
								new OnResultListener<NaverMovies>() {
