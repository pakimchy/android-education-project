...
public class IndexBarView extends View {
    ...
    public void setPinnedHeaderListView(PinnedHeaderListView listView) {
        // list view implements mIndexBarFilter interface
        mIndexBarFilter = listView;
    }
    
    public void setData(ArrayList<String> listItems,ArrayList<Integer> listSections) {
    ...
    public void setData(PinnedHeaderListView listView, ArrayList<String> listItems,ArrayList<Integer> listSections) {
    	setPinnedHeaderListView(listView);
    	setData(listItems, listSections);
    }
