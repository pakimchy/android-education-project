...
public class NetworkManager {
	...
	public static final String URL_AREADATA = SERVER + "/tmap/poi/findPoiAreaDataByName";
	public void getAreaData(Context context, String dongName, int page,
			int count, final OnResultListener<AreaDataResult> listener) {
		RequestParams params = new RequestParams();
		params.put("version", "1");
		params.put("page",""+page);
		params.put("count",""+count);
		params.put("area_dong", dongName);
		
		Header[] headers = new Header[2];
		headers[0] = new BasicHeader("Accept", "application/json");
		headers[1] = new BasicHeader("appKey", "458a10f5-c07e-34b5-b2bd-4a891e024c2a");
		
		client.get(context, URL_AREADATA, headers, params, new TextHttpResponseHandler() {
			
			@Override
			public void onSuccess(int statusCode, Header[] headers,
					String responseString) {
				AreaDataResult result = gson.fromJson(responseString, AreaDataResult.class);
				listener.onSuccess(result);
			}
